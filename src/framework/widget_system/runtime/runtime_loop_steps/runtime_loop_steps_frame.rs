...
pub(crate) fn tab_labels_and_pos(
    ...
    let tab_labels =
        crate::framework::widget_system::runtime::runtime_helpers::tab_labels_for_category(tabs, active_category_name);
    let active_tab_pos =
        crate::framework::widget_system::runtime::runtime_helpers::active_tab_position(tabs, active_category_name, active_tab);
