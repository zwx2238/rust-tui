...
use crate::framework::widget_system::runtime::runtime_view::{ViewAction, ViewState};
...
fn toggle_summary_sort(view: &mut ViewState) -> ViewAction {
    view.summary_sort = match view.summary_sort {
        SummarySort::TabOrder => SummarySort::ExecTime,
        SummarySort::ExecTime => SummarySort::TabOrder,
    };
