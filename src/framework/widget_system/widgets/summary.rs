...
use crate::ui::draw::layout::{inner_area, layout_chunks};
...
fn draw_summary_table_base(
    ...
    scroll: usize,
    theme: &RenderTheme,
    sort: crate::ui::summary::SummarySort,
) {
...
fn build_summary_table<'a>(
    rows: &'a [crate::ui::summary::SummaryRow],
    selected_row: usize,
    scroll: usize,
    theme: &'a RenderTheme,
    sort: crate::ui::summary::SummarySort,
...
fn summary_title(sort: crate::ui::summary::SummarySort) -> &'static str {
    match sort {
        crate::ui::summary::SummarySort::TabOrder => "汇总页 · F1 退出 · Enter 进入 · S 排序(默认)",
