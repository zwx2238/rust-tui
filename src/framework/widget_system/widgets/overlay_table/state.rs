use crate::framework::widget_system::widgets::model::model_popup_area;
use crate::framework::widget_system::overlay::OverlayKind;
use super::{row_at, visible_rows};
use crate::framework::widget_system::widgets::prompt::prompt_popup_area;
use crate::framework::widget_system::runtime::runtime_view::ViewState;
use crate::framework::widget_system::interaction::scroll::max_scroll;
use crate::framework::widget_system::interaction::selection_state::SelectionState;
use crate::framework::widget_system::widgets::help::help_popup_area;
...
fn question_review_metrics(areas: OverlayAreas, counts: OverlayRowCounts) -> OverlayTableMetrics {
    OverlayTableMetrics {
        area: crate::framework::widget_system::widgets::question_review::question_review_list_area(
            areas.full,
