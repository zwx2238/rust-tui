...
use crate::framework::widget_system::widgets::overlay_table::state::{
    OverlayAreas, OverlayRowCounts, overlay_visible_rows,
};
...
pub(crate) fn sync_model_selection(
    view: &mut crate::framework::widget_system::runtime::runtime_view::ViewState,
...
fn overlay_counts(ctx: &DispatchContext<'_>) -> OverlayRowCounts {
    ...
    OverlayRowCounts {
        ...
        question_reviews,
        help: crate::framework::widget_system::widgets::help::help_rows_len(),
    }
}
