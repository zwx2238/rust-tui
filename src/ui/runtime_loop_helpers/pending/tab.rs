...
pub(crate) fn handle_tab_command(params: HandleTabCommandParams<'_>) {
    match params.pending {
        PendingCommand::NewCategory => crate::ui::runtime_loop_helpers::category::create_category_and_tab(
            params.tabs,
            params.active_tab,
            params.categories,
        ...
        PendingCommand::OpenConversation => crate::ui::runtime_loop_helpers::open_conversation::open_conversation_in_tab(
            params.tabs,
            params.active_tab,
            params.categories,
            params.active_category,
